...
// UserProfileImage.js
export const checkPermission = (permissionName , role) => {
  const permissionData = permissions.find((item) => item.role === role)
  const userPermissions = permissionData
    ? permissionData.permissions.find((item) => item[permissionName] !== undefined)
    : null
  const permit = userPermissions && userPermissions[permissionName]
  return permit
}
